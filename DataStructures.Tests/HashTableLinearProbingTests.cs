...
namespace DataStructures.Tests
{
    public class HashTableLinearProbingTests
    {
        ...
        {
            var ht = new HashTableLinearProbing<int, int>();
        ...
        {
            Assert.Throws<ArgumentException>(() => new HashTableLinearProbing<int, int>(-1));
        }

        [Fact]
        public void NewHashTableLoadFactorShouldNotBeLessThanOrEqualToZero()
        {
            Assert.Throws<ArgumentException>(() => new HashTableLinearProbing<int, int>(1, 0));
            Assert.Throws<ArgumentException>(() => new HashTableLinearProbing<int, int>(1, -1));
        }

        [Fact]
        public void NewHashTableLoadFactorShouldNotBeMoreThanOne()
        {
            Assert.Throws<ArgumentException>(() => new HashTableLinearProbing<int, int>(1, 1.2));
            new HashTableLinearProbing<int, int>(1, 1);
        }
        ...
        {
            var ht = new HashTableLinearProbing<int, int>(array.Length);
        ...
        {
            var ht = new HashTableLinearProbing<int, int>(array.Length - 1);
        ...
        {
            var ht = new HashTableLinearProbing<TestKey<int>, int>(array.Length);
        ...
        {
            var ht = new HashTableLinearProbing<int, int>(10);
            foreach (var i in array) ht.Insert(i, i);
        ...
        {
            var ht = new HashTableLinearProbing<string, string>(array.Length);
            foreach (var i in array) ht.Insert(i, i);
        ...
        {
            var ht = new HashTableLinearProbing<string, int>(9);
